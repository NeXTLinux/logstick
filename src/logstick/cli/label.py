...
import logstick
from logstick import artifact, label, store
from logstick.cli import config, display, explore
...
def compare_results_against_labels(
    ...
    results, _, comparisons_by_result_id, stats_by_image_tool_pair = logstick.compare_results_against_labels(
...
def compare_results_against_labels_by_ecosystem(
    ...
    results_by_image, _, stats = logstick.compare_results_against_labels_by_ecosystem(

...
If you look at the [list of logstick issues](https://github.com/nextlinux/logstick/issues) there are plenty of bugs and feature requests.

## Commit guidelines

In the logstick project we like commits and pull requests (PR) to be easy to understand and review. Open source thrives best when everything happening is over documented and small enough to be understood.
...
If you made it this far and all the tests are passing, it's time to submit a Pull Request (PR) for logstick. Submitting a PR is always a scary moment as what happens next can be an unknown. The logstick project strives to be easy to work with, we appreciate all contributions. Nobody is going to yell at you or try to make you feel bad. We love contributions and know how scary that first PR can be.
...
And lastly, when proposed changes are modifying user-facing functionality or output, it is expected the PR will include updates to the documentation as well. logstick is not a project that is heavy on documentation. This will mostly be updating the README and help for the tool.

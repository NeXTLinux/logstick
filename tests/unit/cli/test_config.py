from logstick.cli import config
...
x-ref:
  full-label-set-images: &full-label-set-images
    ...
    - docker.io/nextlinux/test_images:grype-quality-node-d89207b@sha256:f56164678054e5eb59ab838367373a49df723b324617b1ba6de775749d7f91d4
...
test_profile:
  something:
    ...
    refresh: false
"""
    profile_file = tmp_path / ".logstick.profiles.yaml"
